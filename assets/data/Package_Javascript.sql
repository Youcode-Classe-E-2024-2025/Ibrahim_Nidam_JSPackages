...
CREATE TABLE authors (
  author_id int UNIQUE PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE packages (
  package_id int UNIQUE PRIMARY KEY NOT NULL AUTO_INCREMENT,
  name varchar(100) NOT NULL,
  description text,
...
CREATE TABLE versions (
  version_id int UNIQUE PRIMARY KEY NOT NULL AUTO_INCREMENT,
